transparent=!0,transparentDemo=!0,fixedTop=!1,navbar_initialized=!1,backgroundOrange=!1,sidebar_mini_active=!1,toggle_initialized=!1;var is_iPad=null!=navigator.userAgent.match(/iPad/i);function debounce(i,n,t)
{
	...
	{
	var a=this,e=arguments;clearTimeout(s),s=setTimeout(function()
	{
	...
	{
	var i=parseInt(a.slice(1,3),16),n=parseInt(a.slice(3,5),16),t=parseInt(a.slice(5,7),16);return e?"rgba("+i+", "+n+", "+t+", "+e+")":"rgb("+i+", "+n+", "+t+")"}
	...
	);var a=$(".tagsinput").data("color");0!=$(".tagsinput").length&&$(".tagsinput").tagsinput(),$(".bootstrap-tagsinput").addClass(a+"-badge"),0!=$(".selectpicker").length&&$(".selectpicker").selectpicker(
	{
	iconBase:"now-ui-icons",tickIcon:"ui-1_check"}
	...
	{
	var a=$(this).val().replace(/C:\\fakepath\\/i,"");$(this).siblings(".inputFileVisible").val(a)}
